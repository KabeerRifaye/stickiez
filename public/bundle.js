...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(App, null), document.getElementById('stickiez-note'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Note = React.createClass({
		...
		// Show the output
		render: function () {
			if (this.state.editing) return this.renderForm();else return this.renderDisplay();
		}
	});
	...
	var Board = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement('button', { className: 'btn btn-success glyphicon glyphicon-plus',
					onClick: this.add.bind(null, "New Note") })
			);
		}
	});

	// Render Element using ID
	// React.render(<Board count={10}>Create Todays Todo</Board>, document.getElementById('stickiez-note'));
